...
def main_run(dataset,stage, trainDatasetDir, valDatasetDir, stage1_dict, stackSize , out_dir, seqLen, trainBatchSize,
             valBatchSize, numEpochs, lr1, decay_factor, decay_step, memSize,alpha):
    ...
    for epoch in range(numEpochs):
        ...
        for inputs, inputMmap, targets in train_loader:
            ...
            print(inputMmap)
            sys.exit()'''
            loss2 = alpha*loss_fn_regression(mmapPrediction,inputMmap)
...
def __main__():
    ...
    main_run(dataset,stage, trainDatasetDir, valDatasetDir, stage1Dict, stackSize, outDir, seqLen, trainBatchSize,
             valBatchSize, numEpochs, lr1, decayRate, stepSize, memSize,alpha)
